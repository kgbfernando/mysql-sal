...
const pool = require(`promise-mysql/lib/pool`)
const PoolConnection = require('./poolConnection.js');
const SqlString = require('mysql/lib/protocol/SqlString.js')
const promiseCallback = require('promise-mysql/lib/helper').promiseCallback;
...
class mypool extends pool {
    ...
    async queryTrans(stmt, params) {
        const athis = await this.getConnection()
